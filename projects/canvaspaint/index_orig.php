...
<body>
	<img id="myImage" src="/modules/store/product_images/1/63009/24180_lrg.jpg" style="display:none;" />
	...
	<div id="Controls">
		...
		<div>Color: <input type="text" name="Red" value="0"> <input type="text" name="Green" value="0"> <input type="text" name="Blue" value="0"> <input type="text" name="Alpha" value="1.0"> <span onClick="setColor();">Set Color</span><span id="CurrentColor">1</span></div>
