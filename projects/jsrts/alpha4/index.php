...
?>
	...
	<form method="post" enctype="multipart/form-data" name="test" action="ajax/index.php">
	...
	<div id="Game"></div>
	<button type="button" onclick="Game.addUnit('Queue',{PlayerID:Game.getActivePlayerID(),type:'Soldier',startTop:0,startLeft:0});">Add Unit</button>
	<button type="button" onclick="Game.getActions();">Get Actions</button>
	<!--<button type="button" onclick="Game.addUnit({PlayerID:1,type:'Soldier',startTop:Math.round(Math.random() * 500),startLeft:Math.round(Math.random() * 500)});">Add Enemy</button>-->
