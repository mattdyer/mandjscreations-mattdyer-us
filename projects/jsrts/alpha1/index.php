...
?>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			Game.addUnit({player:0,type:'Soldier',startTop:0,startLeft:0,speed:0.2});
	...
	<div id="Game"></div>
	<button type="button" onclick="Game.addUnit({player:0,type:'Soldier',startTop:0,startLeft:0,speed:0.2});">Add Unit</button>
