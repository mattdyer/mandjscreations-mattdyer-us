		...
		htmledit = function(Settings){
			var init = function(){
				...
				$('body').append($('<style type="text/css">' +
										...
										'.ToolBar{z-index:1000; border:1px solid #000; height:20px; width:250px; position:absolute; top:0px; left:0px; background-color:rgba(200,200,200,0.7); font-size:9px;}' +
